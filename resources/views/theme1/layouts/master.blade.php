...
<head>
    ...
    @else
        <link rel="stylesheet" href="{{asset('theme1/assets/bootstrap/css/bootstrap.min.css')}}">
    @endif
    ...
    <link rel="stylesheet" href="{{asset('theme1/assets/fonts/fontawesome-all.min.css')}}">
    <link rel="stylesheet" href="{{asset('theme1/assets/fonts/font-awesome.min.css')}}">
    <link rel="stylesheet" href="{{asset('theme1/assets/fonts/ionicons.min.css')}}">
    <link rel="stylesheet" href="{{asset('theme1/assets/fonts/fontawesome5-overrides.min.css')}}">
    <link rel="stylesheet" href="{{asset('theme1/assets/css/--mp---Testimonials-Slider-Testimonials-Slider.css')}}">
    <link rel="stylesheet" href="{{asset('theme1/assets/css/Animation-Cards.css')}}">
    <link rel="stylesheet" href="{{asset('theme1/assets/css/best-carousel-slide.css')}}">
    <link rel="stylesheet" href="{{asset('theme1/assets/css/figloo-carousal.css')}}">
    <link rel="stylesheet" href="{{asset('theme1/assets/css/Footer-Dark-Multi-Column-icons.css')}}">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.5.2/animate.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/aos/2.3.4/aos.css">
    <link rel="stylesheet" href="{{asset('theme1/assets/css/styles.css')}}">
    <link rel="stylesheet" href="{{asset('theme1/assets/css/Ultimate-Testimonial-Slider.css')}}">
    @if($lang=='ar')
        <style>
    ...
    <div class="container">
        <div class="row d-xl-flex">
            <div class="col-sm-12 col-md-12 col-lg-3 text-center d-flex d-xl-flex flex-row justify-content-center pt-2">
                <a class="text-dark" href="tel: {{$setting->phone}}">
                    <p class="d-xl-flex align-items-xl-center">&nbsp;{{__('lang.phone')}} :<svg xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="col-sm-12 col-md-12 col-lg-3 text-center d-flex d-xl-flex flex-row justify-content-center pt-2">
                <a class="text-dark mx-5" href="#">
                    <p class="d-xl-flex align-items-xl-center">&nbsp;<svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        {{__('lang.address')}} : {{$setting->address->$lang}}<br></p>
                </a></div>
            <div class="col-sm-12 col-md-12 col-lg-3 text-center d-flex d-xl-flex flex-row justify-content-center pt-2">
                <a class="text-dark" href="mailto: {{$setting->email}}">
                    <p class="d-xl-flex align-items-xl-center">{{__('lang.email')}} :
            ...
            <div class="col-sm-12 col-md-12 col-lg-3 text-center d-flex d-xl-flex flex-row justify-content-center">
                ...
                <div class="d-flex flex-row justify-content-center align-items-center m-1">
                    <a class="mx-1  text-center link-top @if(app()->getLocale()=='ar') text-success @endif" href="{{route('setLang',['lang'=>'ar'])}}"><!--<img width="30" src="{{asset('public/assets/img/ksa.png')}}" alt=""
                                                                                     class="img-fluid">-->AR</a>
                    <a class="mx-1 text-center link-top @if(app()->getLocale()=='en') text-success @endif" href="{{route('setLang',['lang'=>'en'])}}"><!--<img width="30" src="{{asset('public/assets/img/usa.png')}}" alt=""
                                                                                        class="img-fluid">-->EN</a>
                    <a class="mx-1  text-center link-top @if(app()->getLocale()=='tr') text-success @endif" href="{{route('setLang',['lang'=>'tr'])}}"><!--<img width="30" src="{{asset('public/assets/img/turk.webp')}}" alt=""
        ...
        <nav class="navbar navbar-light navbar-expand-xl">
            <div class="container">
                <div
                    ...
                    <a class="navbar-brand" href="#" style="background-image: url('{{asset('public/assets/img/logo.png')}}')" ></a></div>
                <button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span
                        class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navcol-1">

                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item px-3"><a class="nav-link nav-link" href="{{route('home')}}">{{__('lang.home')}}</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link text-uppercase px-4 donate" href="{{route('payment')}}">{{__('lang.donate')}}</a></li>
                    </ul>
                </div>
            </div>
        </nav>
...
<script src="{{asset('theme1/assets/js/jquery.min.js')}}"></script>
<script src="{{asset('theme1/assets/bootstrap/js/bootstrap.min.js')}}"></script>
<script src="{{asset('theme1/ssets/js/bs-init.js')}}"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/aos/2.3.4/aos.js"></script>
<script src="{{asset('theme1/ssets/js/--mp---Testimonials-Slider.js')}}"></script>
