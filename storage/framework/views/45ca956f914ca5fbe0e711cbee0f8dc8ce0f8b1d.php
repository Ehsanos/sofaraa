    ...
    <section>
       ...
       <?php echo $campaign->vedio_url; ?>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8">
                    <img class="img-fluid w-100" src="<?php echo e(asset('public/images/camping/'.$campaign->image_url)); ?>" alt="Image">
                </div>
                <div class="col-md-4">
                    <h3 class="my-3"><?php echo e(__('lang.description')); ?></h3>
                    <p><?php echo e($campaign->description->$lang); ?></p>
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><span class="green-color"><?php echo e(__('lang.country')); ?> : </span><?php echo e($campaign->nation->name->$lang); ?></li>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u660431075/domains/mada-dev.tech/public_html/resources/views/camp.blade.php ENDPATH**/ ?>